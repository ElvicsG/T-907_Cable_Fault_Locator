...
public class z_MainActivity extends BaseActivity {
    ...
    public void initFrame() {
        ...
        simZero = StateUtils.getInt(z_MainActivity.this, AppConfig.CURRENT_CURSOR_POSITION, 12);
    }
    ...
    public void initSparkView() {
        ...
        Log.i("Draw", "初始化绘制结束");
        //初始化光标按钮颜色
        btnCursor.setTextColor(ContextCompat.getColor(z_MainActivity.this, R.color.T_purple));
    }
...
//                pointDistance = positionVirtual * density;
    ...
    private void clickCursor() {
        ...
        if (cursorState) {
            btnCursor.setTextColor(ContextCompat.getColor(z_MainActivity.this, R.color.T_red));
        } else {
            btnCursor.setTextColor(ContextCompat.getColor(z_MainActivity.this, R.color.T_purple));
        }
                ...
                if (info != null) {
                    ...
                    singleThreadPool.execute(() -> {
                        try {
                            ...
                            e.printStackTrace();
                            runOnUiThread(() -> Toast.makeText(z_MainActivity.this, getResources().getString(R.string
                    ...
                    tDialog = new TDialog.Builder(getSupportFragmentManager())
                            .setLayoutRes(R.layout.z_connecting_wifi)
                            .setScreenWidthAspect(z_MainActivity.this, 0.25f)
...
//    }
    ...
    public void setSimZero(int simZero) {
        ...
        StateUtils.setInt(z_MainActivity.this, AppConfig.CURRENT_CURSOR_POSITION, simZero);
        Toast.makeText(this, getResources().getString(R.string
