 ...
 * @date 19/06/27
 */
public class z_SplashActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks, EasyPermissions.RationaleCallbacks {
        ...
        singleThreadPool.execute(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    intent.setClass(z_SplashActivity.this, MainActivity.class);
...
//        showProgress();
    ...
    private void InitPulseWidthInfo() {
        ParamInfo paramInfo = (ParamInfo) StateUtils.getObject(z_SplashActivity.this, Constant.PULSE_WIDTH_INFO_KEY);
        if (paramInfo != null) {
        ...
        StateUtils.setObject(z_SplashActivity.this, paramInfo, Constant.PULSE_WIDTH_INFO_KEY);
    ...
    public void startService() {
        Intent intent = new Intent(z_SplashActivity.this, ConnectService.class);
        startService(intent);
    }
